...
export const predefinedDApps: PredefinedDApps = {
  ...
  dapps: [
    ...
    { name: 'DAM', icon: 'https://app.dam.finance/favicon.ico', url: 'https://app.dam.finance/', categories: ['defi'] },
    {
      name: 'Acala Platform',
    ...
    { name: 'Equilibrium', icon: '', url: 'https://app.equilibrium.io/', categories: ['defi'] },
    {
    ...
    { name: 'Braindex | Smart Dex Aggregator', icon: '', url: 'https://www.braindex.io/swap', categories: ['defi'] },
    {
