...
export const overlayColor = convertHexColorToRGBA(ColorMap.dark1, 0.7); // this gives us a black color with a 50% transparency

export const rectDimensions = Math.round(deviceWidth * 0.8); // this is equivalent to 255 from a 393 device width
