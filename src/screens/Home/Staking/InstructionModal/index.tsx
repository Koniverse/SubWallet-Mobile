...
import { InstructionItem } from 'screens/Home/Staking/InstructionModal/InstructionItem';

interface Props {
  setDetailModalVisible: (value: boolean) => void;
  modalVisible: boolean;
  modalTitle: string;
  onPressStake: () => void;
  modalRef?: RefObject<SWModalRefProps>;
}
...
const INSTRUCTION_DATA = [
  ...
  },
  {
    ...
    content: 'It is recommended that you select an active pool. Check out the list of active pools in our FAQ.',
  },
];

export function InstructionModal({ setDetailModalVisible, modalRef, modalVisible, modalTitle, onPressStake }: Props) {
