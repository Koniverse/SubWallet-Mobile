...
export const StakingTypeNameMap = (): Record<string, string> => ({
  ...
  [ExtrinsicType.MINT_VMANTA]: i18n.historyScreen.extrinsicType.mintVMANTA,
  ...
  [ExtrinsicType.REDEEM_VMANTA]: i18n.historyScreen.extrinsicType.redeemVMANTA,
...
export const TxTypeNameMap = (): Record<string, string> => ({
  ...StakingTypeNameMap(),
  [ExtrinsicType.STAKING_SET_CLAIM_PERMISSIONLESS]: 'Add auto claim',
