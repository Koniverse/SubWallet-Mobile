    ...
    <SwModal
      ...
      <View style={receiveModalContentWrapper}>
        ...
        <View style={styles.addressBox}>
          ...
          {!isRelayChainToMigrate && (
            <Button
              icon={<Icon phosphorIcon={CopySimpleIcon} weight={'bold'} size={'sm'} iconColor={theme.colorTextLight4} />}
              type={'ghost'}
              size={'xs'}
          ...
          {isNewFormat === undefined || isNewFormat ? (
            <Button
              ...
              icon={(iconColor: string) => (
                <Icon phosphorIcon={GlobeHemisphereWestIcon} weight={'fill'} size={'lg'} iconColor={iconColor} />
              )}
              type={'secondary'}
              onPress={() => {
            ...
            <Button
              ...
              disabled={!scanExplorerAddressUrl}
              icon={(iconColor: string) => (
                <Icon phosphorIcon={HouseIcon} weight={'fill'} size={'lg'} iconColor={iconColor} />
              )}
              type={'secondary'}
              onPress={() => {
                onBack ? onBack() : modalRef?.current?.close();
