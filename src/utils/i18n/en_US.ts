export const en = {
  ...
  mnemonicSeedWarning: 'Please write down your wallet\'s mnemonic seed and keep it in a safe place. The mnemonic can be used to restore your wallet. Keep it carefully to not lose your assets.',
  ...
  cancel: 'Cancel',
  removeAccountNoti: 'You are about to remove the account. This means that you will not be able to access it via this extension anymore. If you wish to recover it, you would need to use the seed.',
  ...
  phishingMessage: 'You have been redirected because the Polkadot{.js} extension believes that this website could compromise the security of your accounts.',
  ...
  phishingMessage2: 'You have been redirected because the Polkadot{.js} extension believes that this website could compromise the security of your accounts and your tokens.',
  ...
  accountDoesNothaveEnoughFreeFunds: 'The account does not have enough free funds (excluding locked/bonded/reserved) available to cover the transaction fees without dropping the balance below the account existential amount.',
  ...
  sendFundText2: 'Type the amount you want to transfer. Note that you can select the unit on the right e.g sending 1 milli is equivalent to sending 0.001.',
  amountLabel: 'amount',
  ...
  sendFundWarning5: 'There is an existing reference count on the sender account. As such the account cannot be reaped from the state.',
  sendFundWarning6: 'The transaction, after application of the transfer fees, will drop the available balance below the existential deposit. As such the transfer will fail. The account needs more free funds to cover the transaction fees.',
  makeTransfer: 'Make Transfer',
  viewTransaction: 'View Transaction',
  sendFundSuccessful: 'Send Fund Successful',
  authTransactionSuccessfulMessage: 'Your request has been confirmed. You can track its progress on the Transaction History page.',
  sendFundFail: 'Send Fund Fail',
  authTransactionFailMessage: 'There was a problem with your request. You can track its progress on the Transaction History page.',
  ...
  privateKeyWarning: 'The private key must be a string of 0x and 64 characters. If it doesn\'t start with 0x, please add it manually.',
  ...
  noSubstrateAccountMessage: 'You don\'t have any substrate account. Please create, import or restore an account to continue',
  ...
  sendFundWarning10: ' The main token ({{mainToken}}) free balance of the sender is not enough to perform this transaction',
  ...
  selectNetworkMessage: 'Please only select networks that you need to optimize resource consumption. You can always turn them on later if needed',
