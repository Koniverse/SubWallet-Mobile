export const en = {
  common: {
    ...
    stakingValidatorDetail: (validatorLabel: string) => `${validatorLabel} details`,
    submit: 'Submit',
  ...
  importAccount: {
    ...
    accounts: 'Accounts',
    importPrivateKeyMessage: 'To import an existing account, please enter private key.',
  ...
  placeholder: {
    password: 'Password',
    typeYourSubwalletPassword: 'Type your SubWallet master password',
    accountName: 'Account name',
  ...
  emptyScreen: {
    ...
    selectorEmptyMessage: 'Please change your search criteria and try again',
  ...
  stakingScreen: {
    ...
    highestBonded: 'Highest total bond',
  ...
  confirmation: {
    ...
    deleteContactMessage: 'You will no longer see this address in your address book.',
    ...
    siteBlockedMessage: 'This site has previously been blocked. Do you wish to unblock and grant access to it?',
  },
  signingAction: {
    basic: 'Basic',
    detail: 'Detail',
